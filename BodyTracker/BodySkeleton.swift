...
class BodySkeleton: Entity {
    ...
    required init (for bodyAnchor: ARBodyAnchor) {
        ...
        for jointName in ARSkeletonDefinition.defaultBody3D.jointNames{
            ...
            // NOTE: Green joints are actively tracked by ARKit. Yellow joints are not tracked. They just follow the motion of the closest green paternt
            switch jointName {
        ...
        for bone in Bones.allCases {
            ...
            // Create and entity for the bone, add to bones directory, and add it to the parent entity (i.e. bodySkeleton)
